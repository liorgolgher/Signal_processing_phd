...
def get_traces(input_list):
    ...
    for file_num, (file_name, imaging_type, downscale_factors, vessel_numbers, timestep_indices, lines_per_file) in enumerate(input_list):
        ...
        downscaled = downscale_local_mean(np.array(z['time_varying_radon_diameter']), downscale_factors)
        #       
        ...
        datatable[file_num * lines_per_file:(file_num + 1) * lines_per_file, 4] = downscaled # actual vessel diameter per vessel segment per time point
    return datatable
'''
...
ax.title.set_text('Planar (blue) vs. Volumetric (red) of vessel diameter for ' + str(int(num_vessels)) + ' vessel segments.\n Timesteps of ' + str(t_downscale_factors[0]/30) + ' seconds')
...
#ax2.title.set_text('Coefficient of variation for planar and volumetric estimates of vessel diameter for ' + str(int(num_vessels)) + ' vessel segments.\n Timesteps of ' + str(t_downscale_factors[0]/30) + ' seconds')
...
#ax5.title.set_text('Mean Planar vs. Volumetric estimate of vessel diameter for ' + str(int(num_vessels)) + ' vessel segments.\n Timesteps of ' + str(t_downscale_factors[0]/30) + ' seconds')
#fig5.savefig(sfn5, dpi=500)
#g.title.set_text('Mean Planar vs. Volumetric estimate of vessel diameter for ' + str(int(num_vessels)) + ' vessel segments.\n Timesteps of ' + str(t_downscale_factors[0]/30) + ' seconds')
