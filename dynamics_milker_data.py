...
VOI_file_name = 'Overlay Elements of TLP1_Thy2_GCaMP7_FITC_mouse_930nm_1024l_1slow_3p5x_zoom_+100um_heigh_summed_bc_t_FOV1_062_summed_bc_top256_slices_rs2048x2048_bc_3d_gauss_3x3x4.csv'
...
def milk_many_files(file_wc, coordinate_array, reciprocal_axial_intensity_profile):
    ...
    for fnum, fname in enumerate(fn_list):
        ...
        save_fn = fname[:-5] + '_vascular_traces_tz.zarr'
